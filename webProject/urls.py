...
urlpatterns = [
    ...
    path('cambiar-contraseña/', views.edit_password, name='edit_password'),
    ...
    path('quitar-activo-bodega/<int:id_activo>/',                views.del_activo_bodega,  name='del_activo_bodega'),
    
    path('movimientos/',        views.read_movimiento,        name='read_movimiento'),
    path('movimientos-dia/',    views.read_movimiento_dia,    name='read_movimiento_dia'),
    path('movimientos-semana/', views.read_movimiento_semana, name='read_movimiento_semana'),
    path('movimientos-mes/',    views.read_movimiento_mes,    name='read_movimiento_mes'),
    path('movimientos-todo/',   views.read_movimiento_all,    name='read_movimiento_all'),
]